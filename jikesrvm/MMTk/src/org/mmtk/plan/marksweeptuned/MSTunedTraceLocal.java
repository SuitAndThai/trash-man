 ...
 */
@Uninterruptible
public final class MSTunedTraceLocal extends TraceLocal {
  /****************************************************************************
   * Instance fields
   */
   ...
   * Constructor
   */
  public MSTunedTraceLocal(Trace trace, ObjectReferenceDeque modBuffer) {
    super(MSTuned.SCAN_MARK, trace);
