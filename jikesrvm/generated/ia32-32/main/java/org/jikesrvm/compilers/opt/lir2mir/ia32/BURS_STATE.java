...
static BURS_TreeNode kids(BURS_TreeNode p, int eruleno, int kidnumber)  { 
	...
	case 1: // stm: r
		...
		break;
	case 457: // stm: CLEAR_FLOATING_POINT_STATE
	case 456: // double_load: MATERIALIZE_FP_CONSTANT(INT_CONSTANT)
	case 455: // float_load: MATERIALIZE_FP_CONSTANT(INT_CONSTANT)
	case 454: // r: MATERIALIZE_FP_CONSTANT(INT_CONSTANT)
	case 380: // r: GET_TIME_BASE
	case 372: // stm: RETURN(LONG_CONSTANT)
	case 370: // stm: RETURN(INT_CONSTANT)
	case 369: // stm: RETURN(NULL)
	case 368: // stm: PAUSE
	case 367: // stm: FENCE
	...
	case 2: // r: REGISTER
		break;
	case 463: // stm: DOUBLE_IFCMP(double_load,r)
	case 462: // stm: DOUBLE_IFCMP(r,double_load)
	case 461: // stm: DOUBLE_IFCMP(r,r)
	case 460: // stm: FLOAT_IFCMP(float_load,r)
	case 459: // stm: FLOAT_IFCMP(r,float_load)
	case 458: // stm: FLOAT_IFCMP(r,r)
	case 429: // float_load: FLOAT_ALOAD(riv,riv)
	case 428: // r: FLOAT_ALOAD(riv,riv)
	case 427: // float_load: FLOAT_LOAD(riv,riv)
	case 426: // r: FLOAT_LOAD(riv,riv)
	case 425: // double_load: DOUBLE_ALOAD(riv,riv)
	case 424: // r: DOUBLE_ALOAD(riv,riv)
	case 423: // double_load: DOUBLE_LOAD(riv,riv)
	case 422: // r: DOUBLE_LOAD(riv,riv)
	case 417: // r: DOUBLE_REM(r,r)
	case 416: // r: FLOAT_REM(r,r)
	case 411: // r: DOUBLE_DIV(r,double_load)
	case 410: // r: DOUBLE_DIV(r,r)
	case 409: // r: FLOAT_DIV(r,float_load)
	case 408: // r: FLOAT_DIV(r,r)
	case 407: // r: DOUBLE_MUL(double_load,r)
	case 406: // r: DOUBLE_MUL(r,double_load)
	case 405: // r: DOUBLE_MUL(r,r)
	case 404: // r: FLOAT_MUL(float_load,r)
	case 403: // r: FLOAT_MUL(r,float_load)
	case 402: // r: FLOAT_MUL(r,r)
	case 401: // r: DOUBLE_SUB(r,double_load)
	case 400: // r: DOUBLE_SUB(r,r)
	case 399: // r: FLOAT_SUB(r,float_load)
	case 398: // r: FLOAT_SUB(r,r)
	case 397: // r: DOUBLE_ADD(double_load,r)
	case 396: // r: DOUBLE_ADD(r,double_load)
	case 395: // r: DOUBLE_ADD(r,r)
	case 394: // r: FLOAT_ADD(float_load,r)
	case 393: // r: FLOAT_ADD(r,float_load)
	case 392: // r: FLOAT_ADD(r,r)
	case 381: // stm: YIELDPOINT_OSR(any,any)
	case 377: // r: SYSCALL(r,any)
	case 373: // r: CALL(r,any)
	...
	case 15: // any: OTHER_OPERAND(any,any)
		...
		break;
	case 453: // double_load: LONG_BITS_AS_DOUBLE(load64)
	case 452: // r: LONG_BITS_AS_DOUBLE(rlv)
	case 451: // float_load: INT_BITS_AS_FLOAT(load32)
	case 450: // r: INT_BITS_AS_FLOAT(riv)
	case 449: // load64: DOUBLE_AS_LONG_BITS(double_load)
	case 448: // r: DOUBLE_AS_LONG_BITS(r)
	case 447: // load32: FLOAT_AS_INT_BITS(float_load)
	case 446: // r: FLOAT_AS_INT_BITS(r)
	case 445: // r: DOUBLE_2LONG(r)
	case 444: // r: DOUBLE_2INT(r)
	case 443: // r: FLOAT_2LONG(r)
	case 442: // r: FLOAT_2INT(r)
	case 441: // r: DOUBLE_2FLOAT(double_load)
	case 440: // r: DOUBLE_2FLOAT(r)
	case 439: // r: FLOAT_2DOUBLE(float_load)
	case 438: // r: FLOAT_2DOUBLE(r)
	case 437: // r: INT_2DOUBLE(load32)
	case 436: // r: INT_2DOUBLE(riv)
	case 435: // r: INT_2FLOAT(load32)
	case 434: // r: INT_2FLOAT(riv)
	case 421: // r: DOUBLE_MOVE(r)
	case 420: // r: FLOAT_MOVE(r)
	case 419: // r: LONG_2DOUBLE(r)
	case 418: // r: LONG_2FLOAT(r)
	case 415: // r: DOUBLE_SQRT(r)
	case 414: // r: FLOAT_SQRT(r)
	case 413: // r: DOUBLE_NEG(r)
	case 412: // r: FLOAT_NEG(r)
	case 371: // stm: RETURN(r)
	...
	case 77: // stm: BYTE_STORE(BOOLEAN_NOT(UBYTE_LOAD(riv,riv)),OTHER_OPERAND(riv,riv))
		...
		break;
	case 485: // stm: LONG_STORE(load64,OTHER_OPERAND(riv,riv))
	case 484: // stm: LONG_ASTORE(load64,OTHER_OPERAND(riv,riv))
	case 475: // r: FCMP_FCMOV(r,OTHER_OPERAND(double_load,any))
	case 474: // r: FCMP_FCMOV(r,OTHER_OPERAND(float_load,any))
	case 469: // r: FCMP_FCMOV(r,OTHER_OPERAND(r,any))
	case 468: // r: FCMP_CMOV(double_load,OTHER_OPERAND(r,any))
	case 467: // r: FCMP_CMOV(float_load,OTHER_OPERAND(r,any))
	case 466: // r: FCMP_CMOV(r,OTHER_OPERAND(double_load,any))
	case 465: // r: FCMP_CMOV(r,OTHER_OPERAND(float_load,any))
	case 464: // r: FCMP_CMOV(r,OTHER_OPERAND(r,any))
	case 433: // stm: FLOAT_ASTORE(r,OTHER_OPERAND(riv,riv))
	case 432: // stm: FLOAT_STORE(r,OTHER_OPERAND(riv,riv))
	case 431: // stm: DOUBLE_ASTORE(r,OTHER_OPERAND(riv,riv))
	case 430: // stm: DOUBLE_STORE(r,OTHER_OPERAND(riv,riv))
	...
	case 150: // szpr: INT_SHL(riv,INT_AND(r,INT_CONSTANT))
		...
		if (kidnumber == 1)  return p.child2.child1;
		break;
	case 387: // bittest: INT_AND(INT_SHR(r,INT_CONSTANT),INT_CONSTANT)
	case 384: // bittest: INT_AND(INT_USHR(r,INT_CONSTANT),INT_CONSTANT)
	...
	case 224: // stm: BYTE_STORE(INT_2BYTE(r),OTHER_OPERAND(riv,riv))
		...
		if (kidnumber == 2)  return p.child2.child2;
		break;
	case 379: // r: SYSCALL(INT_CONSTANT,any)
	case 376: // r: CALL(INT_CONSTANT,any)
	case 374: // r: CALL(BRANCH_TARGET,any)
	case 302: // r: PREPARE_INT(INT_CONSTANT,address)
		if (kidnumber == 0)  return p.child2;
		break;
	case 473: // r: FCMP_FCMOV(r,OTHER_OPERAND(r,OTHER_OPERAND(double_load,r)))
	case 472: // r: FCMP_FCMOV(r,OTHER_OPERAND(r,OTHER_OPERAND(float_load,r)))
	case 471: // r: FCMP_FCMOV(r,OTHER_OPERAND(r,OTHER_OPERAND(r,double_load)))
	case 470: // r: FCMP_FCMOV(r,OTHER_OPERAND(r,OTHER_OPERAND(r,float_load)))
	...
	case 342: // stm: LONG_STORE(LONG_CONSTANT,OTHER_OPERAND(riv,riv))
		...
		if (kidnumber == 1)  return p.child2.child2;
		break;
	case 378: // r: SYSCALL(INT_LOAD(riv,riv),any)
	case 375: // r: CALL(INT_LOAD(riv,riv),any)
		if (kidnumber == 0)  return p.child1.child1;
		if (kidnumber == 1)  return p.child1.child2;
		if (kidnumber == 2)  return p.child2;
		break;
	case 386: // bittest: INT_AND(INT_SHR(load32,INT_AND(r,INT_CONSTANT)),INT_CONSTANT)
	case 385: // bittest: INT_AND(INT_SHR(r,INT_AND(r,INT_CONSTANT)),INT_CONSTANT)
	case 383: // bittest: INT_AND(INT_USHR(load32,INT_AND(r,INT_CONSTANT)),INT_CONSTANT)
	case 382: // bittest: INT_AND(INT_USHR(r,INT_AND(r,INT_CONSTANT)),INT_CONSTANT)
		if (kidnumber == 0)  return p.child1.child1;
		if (kidnumber == 1)  return p.child1.child2.child1;
		break;
	case 389: // bittest: INT_AND(INT_SHL(INT_CONSTANT,INT_AND(r,INT_CONSTANT)),load32)
	case 388: // bittest: INT_AND(INT_SHL(INT_CONSTANT,INT_AND(riv,INT_CONSTANT)),r)
		if (kidnumber == 0)  return p.child1.child2.child1;
		if (kidnumber == 1)  return p.child2;
		break;
	case 391: // bittest: INT_AND(load32,INT_SHL(INT_CONSTANT,INT_AND(r,INT_CONSTANT)))
	case 390: // bittest: INT_AND(r,INT_SHL(INT_CONSTANT,INT_AND(r,INT_CONSTANT)))
		if (kidnumber == 0)  return p.child1;
		if (kidnumber == 1)  return p.child2.child2.child1;
		break;
	case 480: // r: FCMP_FCMOV(r,OTHER_OPERAND(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,DOUBLE_NEG(r))))
	case 476: // r: FCMP_FCMOV(r,OTHER_OPERAND(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,FLOAT_NEG(r))))
		if (kidnumber == 0)  return p.child1;
		if (kidnumber == 1)  return p.child2.child2.child1;
		if (kidnumber == 2)  return p.child2.child2.child2.child1;
		break;
	case 481: // r: FCMP_FCMOV(r,OTHER_OPERAND(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(DOUBLE_NEG(r),r)))
	case 477: // r: FCMP_FCMOV(r,OTHER_OPERAND(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(FLOAT_NEG(r),r)))
		if (kidnumber == 0)  return p.child1;
		if (kidnumber == 1)  return p.child2.child2.child1.child1;
		if (kidnumber == 2)  return p.child2.child2.child2;
		break;
	case 482: // r: FCMP_FCMOV(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,OTHER_OPERAND(DOUBLE_NEG(r),r)))
	case 478: // r: FCMP_FCMOV(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,OTHER_OPERAND(FLOAT_NEG(r),r)))
		if (kidnumber == 0)  return p.child2.child1;
		if (kidnumber == 1)  return p.child2.child2.child1.child1;
		if (kidnumber == 2)  return p.child2.child2.child2;
		break;
	case 483: // r: FCMP_FCMOV(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,OTHER_OPERAND(r,DOUBLE_NEG(r))))
	case 479: // r: FCMP_FCMOV(MATERIALIZE_FP_CONSTANT(INT_CONSTANT),OTHER_OPERAND(r,OTHER_OPERAND(r,FLOAT_NEG(r))))
		if (kidnumber == 0)  return p.child2.child1;
		if (kidnumber == 1)  return p.child2.child2.child1;
		if (kidnumber == 2)  return p.child2.child2.child2.child1;
		break;
...
void code448(BURS_TreeNode p) {
    SSE2_FPR2GPR_64(P(p));
}
void code450(BURS_TreeNode p) {
    SSE2_GPR2FPR_32(P(p));
}
void code452(BURS_TreeNode p) {
    SSE2_GPR2FPR_64(P(p));
}
